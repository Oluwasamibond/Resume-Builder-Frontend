  ...
  return (
    <DashboardLayout>
      <div className="grid grid-cols-1 md:grid-cols-5 md:gap-7 pt-1 pb-6 px-4 md:px-0">
        <div
          className="h-[300px] flex flex-col gap-5 items-center justify-center bg-white rounded-lg border border-purple-100 hover:border-purple-300 hover:bg-purple-50/50 cursor-pointer"
        ...
        {allResumes?.map((resume) => (
          <ResumeSummaryCard
            ...
            lastUpdated={
              resume?.updatedAt
                ? moment(resume.updatedAt).format("DD MM YY")
                : ""
            }
